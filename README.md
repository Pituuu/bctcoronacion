...
<figure class="wp-block-image size-full"><img src="https://localhost/Wordpress/wp-content/themes/twentytwentyfive/assets/images/ruins-image.webp" alt="Cliff Palace, Colorado" style="aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
